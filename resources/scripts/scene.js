import * as THREE from './three.js-r112/src/Three.js';
import {
    OrbitControls
...
function loadObjects() {
    ...
    loader.load('./resources/models/WVCake.glb', function(gltf) {
...
function lightScene() {
    ...
    let num3 = scene.getObjectByName('Text3');
    num3.castShadow = true;    
    
    let num4 = scene.getObjectByName('Text4');
